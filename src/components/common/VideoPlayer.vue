    ...
    <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-4">
      ...
      <div class="flex items-center justify-between text-white">
        <div class="flex items-center gap-4">
          <button @click="togglePlay" class="hover:scale-110 transition-transform cursor-pointer focus:outline-none">
        ...
        <div class="flex items-center gap-4">
          ...
          <button @click="handleFullscreen" class="hover:scale-110 transition-transform cursor-pointer focus:outline-none">
            <Maximize :size="20" />
          </button>
        </div>
      </div>
